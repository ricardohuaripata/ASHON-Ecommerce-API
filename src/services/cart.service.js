    ...
    if (cart) {
      ...
      const existingItemIndex = cart.items.findIndex((item) => {
        ...
        const isSameVariation =
          item.selectedColor._id.toString() === selectedColor.toString() &&
      ...
      if (existingItemIndex !== -1) {
        ...
        cart.items[existingItemIndex].totalProductQuantity += quantity;
        cart.items[existingItemIndex].totalProductPrice +=
